...
/**
 * Tests JVM para los contratos de InboxUiState.
 *
 ...
 */
class InboxContractsTest {

    @Test
    fun `InboxUiState Error transporta UiErrorReason no String`() {
        val error = InboxUiState.Error(UiErrorReason.NO_CONNECTION)
