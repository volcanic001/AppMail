...
class InboxViewModelRefreshTokenTest {
    ...
    fun `partial refresh clears previous token and blocks pagination`() = runTest(mainDispatcher) {
        val source = RecordingInboxSource(completeResult("page-2"))
...
private class RecordingInboxSource(initialResult: PaginatedResult<Email>) : InboxEmailSource {
