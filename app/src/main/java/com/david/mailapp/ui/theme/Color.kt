...
enum class ColorPalette(
    ...
    Sepia(R.string.palette_sepia, Color(0xFF8C531B),
        Color(0xFFF4ECD8), Color(0xFF362B24), Color(0xFF8C531B)),
    Nord(R.string.palette_nord, Color(0xFF5E81AC),
        Color(0xFFECEFF4), Color(0xFF2E3440), Color(0xFF88C0D0)),
    Gruvbox(R.string.palette_gruvbox, Color(0xFFD79921),
        Color(0xFFFBF1C7), Color(0xFF282828), Color(0xFFFABD2F)),
